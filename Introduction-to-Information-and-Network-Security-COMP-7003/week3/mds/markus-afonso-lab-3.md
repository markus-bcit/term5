...
Configure Permissions:
 ...
 1. netsec-lab3 : Owner can read, write, execute. Group can write and execute. Others are
   restricted/
...
Gave read and execute permissions, this'll be reverted after the lab
  ...
  lab3user@markus:/home/markus$ echo -e "this is a try to write" >> netsec-
  lab3/file
  lab3user@markus:/home/markus$ cat netsec-lab3/file
  this is some line
...
Reflections:
   ...
   All permissions against the created files were working as expected as I double checked
   them using ls- al . But since I created in my /home/markus directory I did have to add
    +rx for the new user to be able to access the file in my home directory.
...
Explanation:
   ...
   What does execute permission mean on a directory?
         x permissions means the user/group can execute command against the directory like
         cd but doesn't allow read commands like ls
...
For every object created, write:
 ...
 1. Object Name: netsec-lab3/
       Owner: markus
       Group: lab3grp
       Sentence: The owner can read, write, and execute. Members of lab3grp can read
       and execute. Others cannot access it.
 2. Object Name: netsec-lab3/file
       Owner: markus
       Group: lab3grp
       Sentence: The owner can read and write. Members of lab3grp can read and write.
       Others cannot access it.
 3. Object Name: netsec-lab3/subdir/
       Owner: markus
       Group: lab3grp
       Sentence: "The owner can read, write, and execute. Members of lab3grp can enter
       but can't list contents. Others cannot access it."
 ...
 5. Object Name: mystery/canread
       ...
       Group: lab3grp
       Sentence: "The owner can read, write, and execute. Members of lab3grp can read
       but only with the file name. Others cannot access it."
...
Submission Summary
  One mistake you made and how testing revealed it:
      Forgot that I created the netsec-lab3 file in my home directory so when I switched to
      the lab3user I couldn't access it, just had to provide permissions.
  Brief explanation of the mystery directory in plain language:
      The directory acts a room with the lights off, if someone knows where to look (the
      name of the file) then they can read it, if not they can't see what the file is called.
